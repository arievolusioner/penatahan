<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Daftar Akun</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="max-w-md mx-auto">
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <button type="submit"
                class="bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 text-white font-semibold rounded-lg py-2.5 px-5 transition duration-150 ease-in-out">
                {{ __('Sign up') }}
            </button>
        </div>
    </form>
